...
export default function HomePage() {
  ...
  return (
    <>
      {/* Loading Screen */}
      {isLoading && (
        <div className="fixed inset-0 z-50 bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center">
          <div className="text-center">
            {/* Logo Animation */}
            <div className="mb-12">
              <h1 className="text-6xl md:text-8xl font-bold text-gray-900 tracking-tight animate-pulse">
                CK <span className="bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">Blogsite</span>
              </h1>
            </div>
            ...
            <div className="mt-8 w-64 mx-auto">
              <div className="h-1 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-gray-600 to-gray-900 rounded-full" 
                     style={{
                       width: '100%',
          ...
          {/* Floating Elements */}
          <div className="absolute top-20 left-20 w-16 h-16 bg-gray-200/30 rounded-full blur-xl animate-bounce" style={{animationDuration: '3s'}}></div>
          <div className="absolute bottom-32 right-24 w-20 h-20 bg-gray-300/20 rounded-full blur-2xl animate-bounce" style={{animationDuration: '4s', animationDelay: '1s'}}></div>
          <div className="absolute top-1/2 right-16 w-12 h-12 bg-gray-100/40 rounded-full blur-lg animate-bounce" style={{animationDuration: '3.5s', animationDelay: '0.5s'}}></div>
      ...
      <div className="fixed inset-0 z-0 w-full h-full">
        ...
        <div
          ...
          style={{
            ...
            backgroundImage: `url('https://images.unsplash.com/photo-1465101046530-73398c7f28ca?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80')`,
      ...
      {/* Enhanced Parallax Overlay for better text readability */}
      <div 
        className="fixed inset-0 z-0"
        style={{
          transform: `translateY(${scrollY * 0.15}px)`,
          background: `
            linear-gradient(135deg, rgba(248, 250, 252, 0.05) 0%, rgba(241, 245, 249, 0.03) 30%, rgba(226, 232, 240, 0.05) 70%, rgba(203, 213, 225, 0.08) 100%)
          `,
          height: '400vh'
        }}
      />
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-8 py-16">
          ...
          <div ref={heroRef} className="text-center mb-32 relative">
            ...
            <div className="relative backdrop-blur-sm bg-white/10 rounded-3xl p-8 border border-white/20">
              ...
              <h1 className={`text-5xl md:text-8xl font-bold text-gray-900 mb-8 tracking-tight transition-all duration-1200 ${isLoaded && isVisible(0) ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'}`}>
                CK <span className="bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">Blogsite</span>
              </h1>
              
              <p className={`text-xl md:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed font-light transition-all duration-1000 delay-200 ${isLoaded && isVisible(0) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          ...
          <div ref={featuresRef} className="mb-32">
            <div className={`text-center mb-16 transition-all duration-1000 ${isVisible(2) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
              <div className="backdrop-blur-sm bg-white/10 rounded-2xl p-8 border border-white/20">
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Why Writers Choose Us</h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto font-light">Everything you need to write, publish, and grow your audience in one beautiful platform.</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              {[
                ...
                <div key={index} className={`group text-center p-10 rounded-3xl bg-white/60 backdrop-blur-sm border border-white/30 hover:bg-white/80 hover:shadow-2xl hover:shadow-gray-200/30 transition-all duration-700 hover:-translate-y-3 ${isVisible(2) ? 'opacity-100 translate-y-0 rotate-0' : 'opacity-0 translate-y-12 rotate-3'}`} style={{ transitionDelay: `${200 + index * 200}ms` }}>
                  ...
                  <p className="text-gray-600 leading-relaxed font-light text-lg mb-6">{feature.description}</p>
          ...
          <div ref={advancedRef} className="mb-32">
            <div className={`text-center mb-16 transition-all duration-1000 ${isVisible(3) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
              <div className="backdrop-blur-sm bg-white/10 rounded-2xl p-8 border border-white/20">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Powerful Features for Modern Writers</h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light">Professional tools that help you focus on what matters most - your writing.</p>
              </div>
            </div>
          ...
          <div ref={testimonialsRef} className="mb-32">
            <div className={`text-center mb-16 transition-all duration-1000 ${isVisible(4) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
              <div className="backdrop-blur-sm bg-white/10 rounded-2xl p-8 border border-white/20">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">What Writers Say</h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light">Join thousands of writers who've made CK Blogsite their creative home.</p>
              </div>
            </div>
          ...
          <div ref={ctaRef} className="mb-20">
            <div className={`relative bg-gradient-to-r from-gray-900/90 to-gray-800/90 backdrop-blur-sm rounded-3xl p-12 md:p-16 text-center text-white overflow-hidden transition-all duration-1000 border border-white/10 ${isVisible(5) ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'}`}>
              <div className="relative">
                <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to Start Your Writing Journey?</h2>
                <p className="text-xl text-gray-200 mb-10 max-w-2xl mx-auto font-light">Join thousands of writers who trust CK Blogsite to share their stories with the world.</p>
          ...
          <div ref={quickLinksRef} className={`text-center relative transition-all duration-1000 ${isVisible(6) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            <div className="relative bg-white/40 backdrop-blur-sm rounded-2xl p-8 border border-white/30">
              <p className="text-gray-500 mb-8 text-lg font-light">Already have an account?</p>
              <div className="flex flex-wrap gap-8 justify-center">
                <a 
                  href="/dashboard" 
                  className="group text-gray-600 hover:text-gray-900 font-medium transition-all duration-300 relative px-6 py-3 rounded-lg hover:bg-white/50 flex items-center space-x-2"
                >
